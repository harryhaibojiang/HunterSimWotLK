...
function setSpellCDs(){
    ...
    if(!!auras.trink1 && !(auras.trink1.effect && auras.trink1.effect.is_proc)) auras.trink1.effect.base_cd = two_min_cds;
    if(!!auras.trink2 && !(auras.trink2.effect && auras.trink2.effect.is_proc)) auras.trink2.effect.base_cd = two_min_cds;
